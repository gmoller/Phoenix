...
namespace PhoenixTests
{
    ...
    public class GuiControlTests_Frame
    {
        ...
        public void Test_frame_creation_top_left_parent_top_left()
        {
            ...
            IControl frame = new Frame(new Vector2(50.0f, 50.0f), Alignment.TopLeft, new Vector2(100.0f, 100.0f), "Icons_1", "", 10, 10, 10, 10, "frame");
            parent.AddControl(frame, Alignment.TopLeft, Alignment.TopLeft);
