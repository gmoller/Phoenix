...
namespace PhoenixTests
{
    ...
    public class GuiControlTests_Frame
    {
        ...
        public void Test_frame_creation_top_left_no_parent()
        {
            ...
            IControl frame = new Frame(new Vector2(100.0f, 100.0f), Alignment.TopLeft, new Vector2(100.0f, 100.0f), "Icons_1", "", 10, 10, 10, 10, null, 0.0f, null, "FrameName");
        ...
        public void Test_frame_creation_bottom_right_no_parent()
        {
            ...
            IControl frame = new Frame(new Vector2(100.0f, 100.0f), Alignment.BottomRight, new Vector2(100.0f, 100.0f), "Icons_1", "", 10, 10, 10, 10, null, 0.0f, null, "FrameName");
        ...
        public void Test_frame_creation_top_left_parent_top_left()
        {
            ...
            var parent = new Frame(new Vector2(100.0f, 100.0f), Alignment.TopLeft, new Vector2(100.0f, 100.0f), "Icons_1", "", 10, 10, 10, 10, null, 0.0f, null, "ParentFrame");

            IControl frame = new Frame(new Vector2(50.0f, 50.0f), Alignment.TopLeft, new Vector2(100.0f, 100.0f), "Icons_1", "", 10, 10, 10, 10, null, 0.0f, parent, "FrameName");
        ...
        public void Test_frame_creation_top_left_parent_bottom_right()
        {
            ...
            var parent = new Frame(new Vector2(100.0f, 100.0f), Alignment.BottomRight, new Vector2(100.0f, 100.0f), "Icons_1", "", 10, 10, 10, 10, null, 0.0f, null, "ParentFrame");
        ...
        public void Test_frame_creation_middle_center_no_parent_half_screen_resolution()
        {
            ...
            IControl frame = new Frame(new Vector2(960.0f, 540.0f), Alignment.MiddleCenter, new Vector2(1920.0f, 1080.0f), "Icons_1", "", 10, 10, 10, 10, null, 0.0f, null, "FrameName");
            Assert.AreEqual(new Point(0, 0), frame.TopLeft);
