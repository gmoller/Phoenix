...
namespace PhoenixTests
{
    ...
    public class GuiControlTests_Frame
    {
        ...
        public void Test_frame_creation_top_left_no_parent()
        {
            ...
            IControl frame = new Frame("FrameName", new Vector2(100.0f, 100.0f), ContentAlignment.TopLeft, new Vector2(100.0f, 100.0f), "Icons_1", "", null, 10, 10, 10, 10);
        ...
        public void Test_frame_creation_bottom_right_no_parent()
        {
            ...
            IControl frame = new Frame("FrameName", new Vector2(100.0f, 100.0f), ContentAlignment.BottomRight, new Vector2(100.0f, 100.0f), "Icons_1", "", null, 10, 10, 10, 10);
        ...
        public void Test_frame_creation_top_left_parent_top_left()
        {
            ...
            var parent = new Frame("ParentFrame", new Vector2(100.0f, 100.0f), ContentAlignment.TopLeft, new Vector2(100.0f, 100.0f), "Icons_1", "", null, 10, 10, 10, 10);

            IControl frame = new Frame("FrameName", new Vector2(50.0f, 50.0f), ContentAlignment.TopLeft, new Vector2(100.0f, 100.0f), "Icons_1", "", null, 10, 10, 10, 10, null, 0.0f, parent);
            ...
            Assert.AreEqual(new Vector2(50.0f, 50.0f), frame.RelativePosition);
        }
        ...
        public void Test_frame_creation_top_left_parent_bottom_right()
        {
            ...
            var parent = new Frame("ParentFrame", new Vector2(100.0f, 100.0f), ContentAlignment.BottomRight, new Vector2(100.0f, 100.0f), "Icons_1", "", null, 10, 10, 10, 10);
        ...
        public void Test_frame_creation_middle_center_no_parent_half_screen_resolution()
        {
            ...
            IControl frame = new Frame("FrameName", new Vector2(960.0f, 540.0f), ContentAlignment.MiddleCenter, new Vector2(1920.0f, 1080.0f), "Icons_1", "", null, 10, 10, 10, 10);
            Assert.AreEqual(new Point(0, 0), frame.TopLeft);
