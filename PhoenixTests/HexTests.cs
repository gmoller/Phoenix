...
namespace PhoenixTests
{
    ...
    public class HexTests
    {
        ...
        {
            var worldHex = HexOffsetCoordinates.FromPixel(0, 0);
        ...
        {
            var worldHex = HexOffsetCoordinates.FromPixel(86, 286);
            Assert.AreEqual(0, worldHex.Col);
        ...
        {
            var worldHex = HexOffsetCoordinates.FromPixel(103, 286);
            Assert.AreEqual(0, worldHex.Col);
            Assert.AreEqual(3, worldHex.Row);
        }
        ...
        {
            var worldHex = HexOffsetCoordinates.FromPixel(381, 575);
        ...
        {
            var worldHex = HexOffsetCoordinates.FromPixel(401, 606);
            Assert.AreEqual(3, worldHex.Col);
            Assert.AreEqual(6, worldHex.Row);
        }
        ...
        {
            var worldHex = HexOffsetCoordinates.FromPixel(405, 617);
            Assert.AreEqual(3, worldHex.Col);
            Assert.AreEqual(6, worldHex.Row);
        }
        ...
        {
            var worldHex = HexOffsetCoordinates.FromPixel(1, 385);
            Assert.AreEqual(0, worldHex.Col);
        ...
        {
            var worldHex = HexOffsetCoordinates.FromPixel(31, 385);
            Assert.AreEqual(0, worldHex.Col);
            Assert.AreEqual(4, worldHex.Row);
        }
    }
