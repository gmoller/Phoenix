...
namespace PhoenixTests
{
    ...
    public class GuiControlTests_Image
    {
        ...
        public void Test_image_creation_top_left_no_parent()
        {
            ...
            IControl image = new Image(new Vector2(100.0f, 100.0f), Alignment.TopLeft, new Vector2(100.0f, 100.0f), "Icons_1", "", 0.0f, null, "ImageName");
        ...
        public void Test_image_creation_top_center_no_parent()
        {
            ...
            IControl image = new Image(new Vector2(100.0f, 100.0f), Alignment.TopCenter, new Vector2(100.0f, 100.0f), "Icons_1", "", 0.0f, null, "ImageName");
        ...
        public void Test_image_creation_top_right_no_parent()
        {
            ...
            IControl image = new Image(new Vector2(100.0f, 100.0f), Alignment.TopRight, new Vector2(100.0f, 100.0f), "Icons_1", "", 0.0f, null, "ImageName");
        ...
        public void Test_image_creation_middle_left_no_parent()
        {
            ...
            IControl image = new Image(new Vector2(100.0f, 100.0f), Alignment.MiddleLeft, new Vector2(100.0f, 100.0f), "Icons_1", "", 0.0f, null, "ImageName");
        ...
        public void Test_image_creation_middle_center_no_parent()
        {
            ...
            IControl image = new Image(new Vector2(100.0f, 100.0f), Alignment.MiddleCenter, new Vector2(100.0f, 100.0f), "Icons_1", "", 0.0f, null, "ImageName");
        ...
        public void Test_image_creation_middle_right_no_parent()
        {
            ...
            IControl image = new Image(new Vector2(100.0f, 100.0f), Alignment.MiddleRight, new Vector2(100.0f, 100.0f), "Icons_1", "", 0.0f, null, "ImageName");
        ...
        public void Test_image_creation_bottom_left_no_parent()
        {
            ...
            IControl image = new Image(new Vector2(100.0f, 100.0f), Alignment.BottomLeft, new Vector2(100.0f, 100.0f), "Icons_1", "", 0.0f, null, "ImageName");
        ...
        public void Test_image_creation_bottom_center_no_parent()
        {
            ...
            IControl image = new Image(new Vector2(100.0f, 100.0f), Alignment.BottomCenter, new Vector2(100.0f, 100.0f), "Icons_1", "", 0.0f, null, "ImageName");
        ...
        public void Test_image_creation_bottom_right_no_parent()
        {
            ...
            IControl image = new Image(new Vector2(100.0f, 100.0f), Alignment.BottomRight, new Vector2(100.0f, 100.0f), "Icons_1", "", 0.0f, null, "ImageName");
        ...
        public void Test_image_creation_top_left_parent_top_left()
        {
            ...
            var parent = new Image(new Vector2(100.0f, 100.0f), Alignment.TopLeft, new Vector2(100.0f, 100.0f), "Icons_1", "", 0.0f, null, "ParentImage");

            var image = new Image(new Vector2(50.0f, 50.0f), Alignment.TopLeft, new Vector2(100.0f, 100.0f), "Icons_1", "", 0.0f, parent, "ImageName");
        ...
        public void Test_image_creation_top_left_parent_bottom_right()
        {
            ...
            var parent = new Image(new Vector2(100.0f, 100.0f), Alignment.BottomRight, new Vector2(100.0f, 100.0f), "Icons_1", "", 0.0f, null, "ParentImage");

            IControl image = new Image(new Vector2(50.0f, 50.0f), Alignment.TopLeft, new Vector2(100.0f, 100.0f), "Icons_1", "", 0.0f, parent, "ImageName");
            Assert.AreEqual(new Point(50, 50), image.TopLeft);
            Assert.AreEqual(new Point(150, 50), image.TopRight);
            Assert.AreEqual(new Point(50, 150), image.BottomLeft);
            Assert.AreEqual(new Point(150, 150), image.BottomRight);
        ...
        public void Test_image_creation_middle_center_no_parent_half_screen_resolution()
        {
            ...
            IControl image = new Image(new Vector2(960.0f, 540.0f), Alignment.MiddleCenter, new Vector2(1920.0f, 1080.0f), "Icons_1", "", 0.0f, null, "ImageName");
            Assert.AreEqual(new Point(0, 0), image.TopLeft);
