...
namespace GuiControls
{
    public abstract class ControlBase : IControl
    {
        ...
        protected ControlBase(string name, Vector2 position, ContentAlignment alignment, Vector2 size, string textureAtlas, string textureName, byte? textureId = null, float layerDepth = 0.0f, IControl parent = null)
        {
            Parent = parent;
