...
{
    public class ButtonOld : ControlOld
    {
        ...
        public ButtonOld(string name, Vector2 position, HorizontalAlignment horizontalAlignment, VerticalAlignment verticalAlignment, Vector2 size, string guiTextures, string textureNormal, string textureActive, string textureDisabled, string textureHover) :
