...
{
    public abstract class ControlOld
    {
        ...
        protected ControlOld(string name, Vector2 position, HorizontalAlignment horizontalAlignment, VerticalAlignment verticalAlignment, Vector2 size) :
            this(name, null, horizontalAlignment, verticalAlignment, size)
        {
            Position = position;
        }

        protected ControlOld(string name, ControlOld controlToDockTo, HorizontalAlignment horizontalAlignment, VerticalAlignment verticalAlignment, Vector2 size)
        {
            Name = name;
