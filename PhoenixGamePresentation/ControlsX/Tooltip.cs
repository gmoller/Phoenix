...
//    public class Tooltip : ControlWithMultipleTextures
//    {
//        #region State
...
//                Size = size.ToPointI(),
//                BorderSizeTop = topPadding,
//                BorderSizeBottom = bottomPadding,
//                BorderSizeLeft = leftPadding,
//                BorderSizeRight = rightPadding,
//                Position = position.ToPointI()
//            };
//            AddControl(frame);
//            frame.AddControl(new Image("TransparentBackground") {TextureName = "background" }, Alignment.MiddleCenter, Alignment.MiddleCenter);
