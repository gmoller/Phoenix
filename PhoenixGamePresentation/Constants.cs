...
namespace PhoenixGamePresentation
{
    public static class Constants
    {
        ...
        public static readonly int WORLD_MAP_HEIGHT_IN_PIXELS = (PhoenixGameLibrary.Constants.WORLD_MAP_ROWS / 2 * (int)Hex.Constants.HexHeight) + (PhoenixGameLibrary.Constants.WORLD_MAP_ROWS / 2 * (int)Hex.Constants.HexHalfHeight) + (int)Hex.Constants.HexQuarterHeight;
