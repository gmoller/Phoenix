...
namespace PhoenixGamePresentationLibrary.SettlementView
{
    internal class ProducingFrame
    {
        ...
        {
            _smallFrame = new Frame("SmallFrame", _topLeftPosition + new Vector2(0.0f, 10.0f), ContentAlignment.TopLeft, new Vector2(515, 160), "GUI_Textures_1", "frame2_whole", 50, 50, 50, 50);
