...
namespace PhoenixGamePresentationLibrary.Views
{
    public class OverlandSettlementView
    {
        ...
        private void DrawSettlement(SpriteBatch spriteBatch, Cell cell)
        {
            ...
            var destinationRectangle = new Rectangle((int)position.X, (int)position.Y, (int)(HexLibrary.Constants.HexActualWidth * Constants.ONE_HALF), (int)(HexLibrary.Constants.HexActualHeight * 0.75f));
