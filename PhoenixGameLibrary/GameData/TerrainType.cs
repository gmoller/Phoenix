...
namespace PhoenixGameLibrary.GameData
{
    ...
    public static class TerrainTypesLoader
    {
        public static NamedDataDictionary<TerrainType> Load()
        {
            ...
            //var terrainTypes = new List<TerrainType>
            //{
            //    TerrainType.Create(0, "Grassland", new MovementCosts(new MovementCost("Walking", 1.0f), new MovementCost("Mountaineer", 3.0f), new MovementCost("Flying", 1.0f), new MovementCost("Sailing", 0.0f)), ColorRgba.LightGreen, new Texture(terrain3, 6)),
            //    TerrainType.Create(1, "Forest", new MovementCosts(new MovementCost("Walking", 2.0f), new MovementCost("Forester", 1.0f), new MovementCost("Flying", 1.0f), new MovementCost("Sailing", 0.0f)), ColorRgba.ForestGreen, new Texture(terrain1, 16), new Texture(terrain1, 17), new Texture(terrain1, 18), new Texture(terrain1, 19)),
            //    TerrainType.Create(2, "Desert", new MovementCosts(new MovementCost("Walking", 1.0f), new MovementCost("Flying", 1.0f), new MovementCost("Sailing", 0.0f)), ColorRgba.SandyBrown, new Texture(terrain1, 12), new Texture(terrain1, 13), new Texture(terrain1, 14), new Texture(terrain3, 5)),
            //    TerrainType.Create(3, "Swamp", new MovementCosts(new MovementCost("Walking", 3.0f), new MovementCost("Flying", 1.0f), new MovementCost("Swimming", 1.0f), new MovementCost("Sailing", 0.0f)), ColorRgba.SeaGreen, new Texture(terrain1, 20), new Texture(terrain1, 21), new Texture(terrain1, 22), new Texture(terrain1, 23)),
            //    //TerrainType.Create(4, "River", 2.0f, 2.0f, 0.0f),
            //    //TerrainType.Create(5, "River Mouth", 2.0f, 2.0f, 2.0f),
            //    TerrainType.Create(6, "Hill", new MovementCosts(new MovementCost("Walking", 3.0f), new MovementCost("Mountaineer", 1.0f), new MovementCost("Flying", 1.0f), new MovementCost("Sailing", 0.0f)), ColorRgba.Tan, new Texture(terrain1, 32), new Texture(terrain1, 33), new Texture(terrain1, 34), new Texture(terrain1, 35)),
            //    TerrainType.Create(7, "Mountain", new MovementCosts(new MovementCost("Walking", 4.0f), new MovementCost("Mountaineer", 1.0f), new MovementCost("Flying", 1.0f), new MovementCost("Sailing", 0.0f)), ColorRgba.SaddleBrown, new Texture(terrain1, 8), new Texture(terrain1, 9), new Texture(terrain1, 10), new Texture(terrain1, 11)),
            //    //TerrainType.Create(8, "Volcano", 4.0f, 0.0f, 0.0f),
            //    TerrainType.Create(9, "Tundra", new MovementCosts(new MovementCost("Walking", 2.0f), new MovementCost("Flying", 1.0f), new MovementCost("Swimming", 1.0f), new MovementCost("Sailing", 0.0f)), ColorRgba.Snow, new Texture(terrain2, 8), new Texture(terrain2, 9), new Texture(terrain2, 10), new Texture(terrain2, 11)),
            //    //TerrainType.Create(10, "Shore", -1.0f, 0.5f, 0.0f),
