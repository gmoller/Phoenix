...
namespace PhoenixGameLibrary.GameData
{
    ...
    public struct UnitType : IIdentifiedByIdAndName
    {
        ...
        private UnitType(int id, string name, string shortName, float constructionCost, Moves moves, string textureName, List<string> whichRacesCanBuild, List<string> dependsOnBuildings, List<string> actions)
        {
            Id = id;
            Name = name;
            ShortName = shortName;
        ...
        public static UnitType Create(int id, string name, string shortName, float constructionCost, Moves moves, string textureName, List<string> whichRacesCanBuild, List<string> dependsOnBuildings, List<string> actions)
        {
            return new UnitType(id, name, shortName, constructionCost, moves, textureName, whichRacesCanBuild, dependsOnBuildings, actions);
        }
    ...
    public static class UnitTypesLoader
    {
        public static NamedDataList<UnitType> Load()
        {
            var unitTypes = new List<UnitType>
            {
                ...
                UnitType.Create(5, "Barbarian Shamans", "Shamans", 50.0f, new Moves(new Move("Ground", 1.0f)), "Unit_Icon_BarbarianShamans_Transparent", new List<string> { "Barbarians" }, new List<string> { "Shrine" }, new List<string> { "Done", "Patrol", "Wait" }),
                UnitType.Create(6, "Barbarian Trireme", "Trireme", 60.0f, new Moves(new Move("Water", 2.0f)), "Unit_Icon_Trireme_Transparent", new List<string> { "Barbarians" }, new List<string> { "Shipwrights Guild" }, new List<string> { "Done", "Patrol", "Wait" }),
                UnitType.Create(7, "Barbarian Galley", "Galley", 100.0f, new Moves(new Move("Water", 3.0f)), "Unit_Icon_Galley_Transparent", new List<string> { "Barbarians" }, new List<string> { "Shipyard" }, new List<string> { "Done", "Patrol", "Wait" }),
